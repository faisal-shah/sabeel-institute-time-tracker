 ...
 * an ESLint rule enforces this everywhere under app/src except app/src/theme and
 * app/src/printStatement.web.ts (a print stylesheet; see that file).
 *
 ...
 * apps shipped the old hues, so this is a coordinated change. The sibling kanban
 * app is the reference implementation and matches this same palette.
 *
...
export const palette = {
  ...
  accentText: '#F9F2E9',
  accentSoft: '#E6CCC9',
  // Pale ivory-pink for muted text ON a raspberry fill (e.g. the running-timer
  // card): softer than full textInverse but still legible on the plum.
  ...
  // Decorative gold & sage — this app uses both as accents more than kanban does.
